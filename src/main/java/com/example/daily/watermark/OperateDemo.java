...
public class OperateDemo {
    ...
    public static void main(String[] args) throws QiniuException {
        // 设置账号的AK,SK
        String ACCESS_KEY = "s-9iPJtQwFmxnxZnrS0gBfFEEFqHRcizmaOheKJv";
        String SECRET_KEY = "SDsaXrHhFvo1UxYe8crqNSdXV5AZF9kcoLl9BaVe";
        Auth auth = Auth.create(ACCESS_KEY, SECRET_KEY);
        Configuration cfg = new Configuration(Zone.zone0());
        // 新建一个OperationManager对象
        OperationManager operater = new OperationManager(auth, cfg);
        // 设置要转码的空间和key，并且这个key在你空间中存在
        String bucket = "wakuangmall";
        String key = "8e8fb3f192aa4538843414e6050a6996.jpg";
        // 需要添加水印的图片UrlSafeBase64,可以参考http://developer.qiniu.com/code/v6/api/dora-api/av/video-watermark.html
        String pictureurl = UrlSafeBase64
                .encodeToString("http://developer.qiniu.com/resource/logo-2.jpg");
        // 设置转码操作参数
